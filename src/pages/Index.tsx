        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            ...
            <div className="space-y-6">
              <img src={heroTitle} alt="Let's Go out!" className="w-full max-w-[500px] h-auto drop-shadow-2xl" />
              <h2 className="text-lg sm:text-xl text-white/90 leading-relaxed drop-shadow-md">
                A rede social para quem quer viver mais, encontrar pessoas com os mesmos interesses, aprender algo novo
                e se manter em movimento.
              </h2>
              <Button
                size="lg"
                onClick={() => navigate("/auth")}
              ...
              <div className="grid gap-6 sm:gap-8 md:grid-cols-3 pt-8">
                <Card className="bg-[#F3F2EF] border-none">
                  <CardContent className="p-6 text-center space-y-3">
                    ...
                    <p className="text-[#6F6F6F]">Oficinas, aulas e trocas culturais</p>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-[#F3F2EF] border-none">
                  <CardContent className="p-6 text-center space-y-3">
                    ...
                    <p className="text-[#6F6F6F]">Conecte-se por afinidades, não por likes</p>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-[#F3F2EF] border-none">
                  <CardContent className="p-6 text-center space-y-3">
                    ...
                    <p className="text-[#6F6F6F]">Corpo e mente ativos, dentro e fora dos espaços comuns</p>
                  </CardContent>
                </Card>
              </div>
            </CardContent>
      ...
      >
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 relative z-10">
          <Card className="border-none shadow-lg bg-white/95 backdrop-blur-sm">
            <CardContent className="p-8 sm:p-12 space-y-8">
              <div className="text-center space-y-4">
                <h2 className="text-3xl sm:text-4xl font-bold text-[#333333]">Conexões seguras, experiências reais.</h2>
              ...
              <div className="grid gap-6 sm:grid-cols-3">
                ...
                <div className="flex flex-col items-center text-center space-y-3">
                  ...
                  <p className="text-sm text-[#6F6F6F]">Imagens conferidas para garantir autenticidade.</p>
                </div>
                ...
                <div className="flex flex-col items-center text-center space-y-3">
                  ...
                  <p className="text-sm text-[#6F6F6F]">Sua privacidade é prioridade.</p>
                </div>
              </div>

              <p className="text-center text-[#6F6F6F] max-w-2xl mx-auto">
                Assim, você pode explorar a cidade e conhecer pessoas com tranquilidade — sabendo que todo encontro
                começa de forma segura e verdadeira.
              </p>
            </CardContent>
          </Card>
        </div>
